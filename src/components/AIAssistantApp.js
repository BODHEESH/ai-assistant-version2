...
const features = [
  ...
  { name: 'Create Poem', color: 'bg-purple-400', category: 'creative' },
  { name: 'Ask Anything', color: 'bg-blue-400', category: 'general' },
  ...
  { name: 'Music Recommendations', color: 'bg-indigo-500', category: 'entertainment' },
  { name: 'Math Solver', color: 'bg-blue-500', category: 'education' },
  { name: 'Grammar Checker', color: 'bg-cyan-600', category: 'writing' },
  { name: 'Programming Help', color: 'bg-green-400', category: 'development' },
  { name: 'Time Zone Converter', color: 'bg-purple-500', category: 'utility' },
  { name: 'Pet Care Tips', color: 'bg-pink-500', category: 'lifestyle' },
  { name: 'Travel Advice', color: 'bg-blue-300', category: 'lifestyle' },
  { name: 'Word Definitions', color: 'bg-indigo-400', category: 'education' },
  { name: 'Daily Motivational Quotes', color: 'bg-yellow-500', category: 'personal' },
  { name: 'Virtual Interview Practice', color: 'bg-red-500', category: 'career' },
  { name: 'Memory Techniques', color: 'bg-teal-500', category: 'education' },
  { name: 'Time Management Tips', color: 'bg-amber-500', category: 'productivity' },
  { name: 'Positive Habit Formation', color: 'bg-green-300', category: 'personal' },
  { name: 'Career Path Planning', color: 'bg-blue-700', category: 'career' },
  { name: 'Speech Writing Help', color: 'bg-rose-500', category: 'writing' },
  { name: 'Stress Relief Exercises', color: 'bg-emerald-500', category: 'health' },
  { name: 'LinkedIn Post', color: 'bg-blue-800', category: 'content' },
  { name: 'Hashnode Blog', color: 'bg-indigo-600', category: 'content' },
  { name: 'Technical Article', color: 'bg-sky-600', category: 'content' },
  { name: 'Study Notes', color: 'bg-teal-600', category: 'education' },
  { name: 'Email Writer', color: 'bg-violet-500', category: 'writing' },
  { name: 'Social Media Manager', color: 'bg-pink-400', category: 'marketing' },
  { name: 'Business Plan', color: 'bg-amber-600', category: 'business' },
  { name: 'Resume Builder', color: 'bg-red-600', category: 'career' },
  { name: 'Project Manager', color: 'bg-emerald-600', category: 'business' },
  { name: 'Design Assistant', color: 'bg-fuchsia-500', category: 'creative' },
  { name: 'Research Assistant', color: 'bg-cyan-500', category: 'education' },
  { name: 'Video Script', color: 'bg-rose-600', category: 'content' },
  { name: 'Financial Advisor', color: 'bg-lime-600', category: 'finance' },
...
function getFeatureDescription(featureName) {
  const descriptions = {
    ...
    'Create Poem': 'Write beautiful poetry with various styles',
    'Ask Anything': 'Get answers to any question on any topic',
    ...
    'Music Recommendations': 'Discover new music based on your taste',
    'Math Solver': 'Solve complex math problems',
    'Grammar Checker': 'Perfect your writing',
    'Programming Help': 'Get help with coding and development',
    'Time Zone Converter': 'Convert times across different zones',
    'Pet Care Tips': 'Expert advice for pet care',
    'Travel Advice': 'Get travel tips and recommendations',
    'Word Definitions': 'Get detailed word meanings and usage',
    'Daily Motivational Quotes': 'Start your day with inspiration',
    'Virtual Interview Practice': 'Prepare for job interviews',
    'Memory Techniques': 'Improve your memory and retention',
    'Time Management Tips': 'Boost your productivity',
    'Positive Habit Formation': 'Build lasting positive habits',
    'Career Path Planning': 'Plan your career progression',
    'Speech Writing Help': 'Create impactful speeches',
    'Stress Relief Exercises': 'Manage and reduce stress',
    'LinkedIn Post': 'Create engaging professional posts',
    'Hashnode Blog': 'Write technical blog posts',
    ...
    'Social Media Manager': 'Optimize social media content',
